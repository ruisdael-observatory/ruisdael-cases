...
class _IFS_vegetation:
    def __init__(self):
        ...
        raw_data = np.array([
            ...
            # [ 0,    1.0,     1.0,       100,  0.50, 0.00/100., 10.739, 2.608,  30.0*1.0, 30.0*1.0, 0.00,  1,  2  ],    # 20 "Urban"
            [ 0,    1.0,     1.0,       1e9,  0.50, 0.00/100., 10.739, 2.608,  30.0, 30.0, 0.00,  1,  2  ],    # 20 "Urban"
