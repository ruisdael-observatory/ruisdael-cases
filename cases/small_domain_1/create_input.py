...
if __name__ == '__main__':
    ...
    start  = datetime.datetime(year=2017, month=5, day=27)
    end    = datetime.datetime(year=2017, month=5, day=28)
    ...
    path_out = '/projects/0/einf170/janssonf/DALES_runs/'
